...
module.exports = {
  pack() {
    ...
    const sourcePath = [
      ...
      path.join(servicePath, `bin/${this.configuration}/netcoreapp2.2/publish/`),
      path.join(servicePath, `bin/${this.configuration}/netcoreapp3.0/publish/`),
      path.join(servicePath, `bin/${this.configuration}/netcoreapp3.1/publish/`)
    ].find(fs.existsSync);
